#
# Ruta y otras funciones para el guiado del dron
#
...
parser = argparse.ArgumentParser(description='Ruta y otras funciones para el guiado del dron')

parser.add_argument('--inf_ruta', action='store_true',
                    help='Especifica si la ruta se repite indefinidamente o el dron aterriza')
...
def goto(dNorth, dEast, gotoFunction=vehicle.simple_goto):
    ...
    while vehicle.mode.name=="GUIDED": #Stop action if we are no longer in guided mode.
        ...
        print("Distancia al destino: ", remainingDistance)
...
armado_y_despegue(150)
tiempo_inicio = time.time()

while True:
	print("Velocidad establecida en 10m/s")
	vehicle.groundspeed=10

	print("Posición Norte 800 Oeste 500")
	goto(800, -500)

	print("Posición Norte 0 Este 1000")
	goto(0, 1000)

	print("Posición Norte -800 Oeste 500")
	goto(-800, -500)
	
	if not args.inf_ruta:
		break
...
aLocation = Location(-8.7796,42.2854,20);
